...
function adminSitePages(): array
{
    ...
    $pages[] = [
        'id' => 'sostavlenie-kollagey',
        'title' => 'Коллажи и реставрация',
        ...
        'modules' => [
            ...
            ['id' => 'preview', 'title' => 'Предпросмотр страницы', 'description' => 'Открыть страницу коллажей и проверить изменения', 'status' => 'active'],
        ],
    ];
